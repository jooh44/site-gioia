...
function CtaButton({ accent }: { accent: "primary" | "secondary" }) {
  return (
    <a
      ...
      rel="noreferrer"
      className={cn(
        "inline-flex items-center h-12 px-8 text-xs uppercase tracking-[0.2em] font-bold transition-colors",
        accent === "primary"
...
function DesktopServices() {
  ...
  return (
    <div className="hidden lg:grid lg:grid-cols-[minmax(0,2fr)_minmax(0,5fr)] border-t border-stone-200">
        ...
        {serviceGroups.map((group, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full text-left px-8 py-5 border-b border-stone-200 transition-colors cursor-pointer",
